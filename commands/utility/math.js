...
module.exports = {
        ...
        .addStringOption(option =>
            option
                ...
                .addChoices(
                    ...
                    { name: 'Chapter 3: Applications of Differentiation', value: 'chapter3' },
                    ...
                    { name: "Chapter 8: Integration Techniques, L'Hopital's Rule, and Improper Integrals", value: 'chapter8' },
    ...
    async execute(interaction) {
        ...
        const questionData = getRandomMathQuestion(interaction.options.getString('chapter'));
